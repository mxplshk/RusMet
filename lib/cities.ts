...
const reviewPool = [
  ...
  { name: 'Андрей Козлов', role: 'Директор, ООО\u00a0«МеталлМонтаж»', tpl: 'Снабжаемся через РусМет для\u00a0объектов {in}. Стабильные цены, оперативная отгрузка. Всё по\u00a0договору.', date: '3\u00a0сентября 2024' },
  ...
  { name: 'Татьяна Кузнецова', role: 'Бухгалтер, ООО\u00a0«Стройресурс»', tpl: 'Работаем с\u00a0РусМет уже год\u00a0— поставки {in} всегда вовремя. Документы без\u00a0ошибок, счета выставляют моментально.', date: '17\u00a0мая 2024' },
  ...
  { name: 'Алексей Сидоров', role: 'Прораб, ИП', tpl: 'Строим коттедж {in}, закупались полностью через РусМет. Арматура, трубы, сетка\u00a0— всё привезли одной машиной.', date: '20\u00a0марта 2024' },
